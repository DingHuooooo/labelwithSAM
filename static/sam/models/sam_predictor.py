...
class SAM_Predictor():
    def __init__(self, model_type = 'SAM_ViT_L', device = torch.device("cpu")):
        ...
        if model_type == 'SAM_ViT_L':
            ...
            self.ckpt_path = './static/sam/sam_ckpt/sam_vit_l_0b3195.pth'
        elif model_type == 'SAM_ViT_B':
            self.model_type = 'vit_b'
            self.ckpt_path = './static/sam/sam_ckpt/sam_vit_b_01ec64.pth'
        elif model_type == 'SAM_ViT_H':
            self.model_type = 'vit_h'
            self.ckpt_path = './static/sam/sam_ckpt/sam_vit_h_4b8939.pth'
